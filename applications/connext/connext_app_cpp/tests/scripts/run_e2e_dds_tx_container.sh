...
#
# Container-based TX application launcher for DDS end-to-end testing
# This script runs the connext_sender_receiver app in TX mode with DDS transport
#
# Prerequisites:
...
echo "=================================================="
echo "Connext DDS E2E Test - TX Container"
echo "=================================================="
...
# Run TX application in container
...
./holohub run-container connext_app_cpp \
  ...
  -- /bin/bash -c "echo '=== Starting connext_app (DDS TX) ===' && $PATH_TO_APP/connext_app $PATH_TO_APP/tests/config/test_dds_tx.yaml 2>&1 || echo 'Exit code:' \$?"